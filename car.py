...
NUM_BINS = [15,       15]  # This needs to be changed
...
if __name__ == '__main__':
    ...
    if train:
        ...
        Q = np.zeros([255, env.action_space.n]) #The number 9999 needs to be changed every time you chan change NUM_BINS
    if test:
    ...
    alpha = 0.1  # This needs to be changed ( same as problem 1)
    ...
    eps_decay = 100000
    if train:
        n_episodes = 10001     # This might need to be changed
        time = 1 
        for episode in range(n_episodes):
            ...
            while done != True:
                ...
                Q[s,action] = Q[s, action] + alpha * (reward + gamma * predicted_value - Q[s, action]) # This needs to be changed similar to problem 1
